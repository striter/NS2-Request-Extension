...
for _, soundData in pairs(kSoundData) do
    ...
    if soundData.Sound ~= nil and string.len(soundData.Sound) > 0 then
        ...
        if string.find(soundData.Sound, "sound/NS2.fev/alien/", 1) == nil and not string.find(soundData.Sound, "CNTaunts.fev", 1) and not table.icontains(macVOs, _) then
...
local kMarineMenu =
{
    ...
    [RIGHT_MENU] = { kVoiceId.MarineTaunt,kVoiceId.Disease, kVoiceId.MarineCovering, kVoiceId.MarineFollowMe, kVoiceId.MarineHostiles, kVoiceId.MarineAcknowledged}
}
...
local kMarineMacMenu =
{
    ...
    [RIGHT_MENU] = { kVoiceId.Mac_Taunt,kVoiceId.Disease,  kVoiceId.Mac_Covering, kVoiceId.Mac_FollowMe, kVoiceId.Mac_Hostiles, kVoiceId.Mac_Acknowledged}
}
...
local kMarineMilMacMenu =
{
    ...
    [RIGHT_MENU] = { kVoiceId.MilMac_Taunt,kVoiceId.Disease, kVoiceId.MilMac_Covering, kVoiceId.MilMac_FollowMe, kVoiceId.MilMac_Hostiles, kVoiceId.MilMac_Acknowledged}
}
...
local kAlienMenu =
{
    ...
    [RIGHT_MENU] = { kVoiceId.AlienTaunt,kVoiceId.Disease,kVoiceId.AlienChuckle }    
}

local kEmbryoMenu = 
{
    [LEFT_MENU] = { kVoiceId.AlienRequestMist },
    [RIGHT_MENU] = { kVoiceId.AlienTaunt,kVoiceId.Disease,kVoiceId.EmbryoChuckle }
}
...
function GetRequestMenu(side, className , teamType)
